...
public interface AnalizadorListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link AnalizadorParser#decision}.
	 * @param ctx the parse tree
	 */
	void enterDecision(AnalizadorParser.DecisionContext ctx);
	/**
	 * Exit a parse tree produced by {@link AnalizadorParser#decision}.
	 * @param ctx the parse tree
	 */
	void exitDecision(AnalizadorParser.DecisionContext ctx);
	/**
